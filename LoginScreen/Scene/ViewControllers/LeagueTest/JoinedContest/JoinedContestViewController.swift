...
//        setNoDataLabel()
    ...
    func inviteAction(code: String) {
        let textToShare = [ "Here I challenge you to join my challenge Click \(kAppStoreURL) to download Cric22 app & use my code \(code) to Play with me." ]
...
extension JoinedContestViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return myjoinedContestdata.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let leagues = myjoinedContestdata[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let cID = myjoinedContestdata[indexPath.row].challenge_id, let fees = myjoinedContestdata[indexPath.row].entryfee {
            openContestDetail(challengeIds: cID, leagues: myjoinedContestdata[indexPath.row], entreFees: fees)
        }
    }

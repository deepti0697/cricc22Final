...
//
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if isPlayerAdeed {
            ...
            addandRemoveButton.backgroundColor = UIColor(red: 253, green: 185, blue: 40)
              addandRemoveButton.setTitleColor(.black, for: .normal)
        }
        else {
               addandRemoveButton.backgroundColor = UIColor(red: 253, green: 185, blue: 40)
            addandRemoveButton.setTitleColor(.black, for: .normal)
...
//        ftechplayerInfo()
    ...
    func setPlayerInfoData() {
       ...
       // aSelectedByLabel.text = playerInfo?.selected_by ?? "0%"

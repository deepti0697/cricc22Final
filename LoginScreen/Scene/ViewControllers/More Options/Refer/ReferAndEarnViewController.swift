...
class ReferAndEarnViewController: BaseClass {
   ...
   // @IBOutlet weak var aLabel: UILabel!
    ...
    @IBAction func aShareButtonAction(_ sender: Any) {
        ...
        let textToShare = [ "Here's ₹500 to play fantasy cricket with me on DeamTeam and Also Earn Unlimited Real Cash with referred Friend for Lifetime . Click \(kAppStoreURL) to download Cric22 app & use My code \(referCode) To Register" ]

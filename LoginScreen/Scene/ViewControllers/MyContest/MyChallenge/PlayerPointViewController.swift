...
//                               team1ImageView?.sd_setImage(with: imageUrl, placeholderImage: #imageLiteral(resourceName: "team_placeholder"), options: .continueInBackground) { (img, err, cacheType, url) in
//                               }
//                           }
...
//                                         let urlString = imagePath.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)
//                                         let imageUrl = URL(string: urlString ?? "")
//                                         team2ImageView?.sd_setImage(with: imageUrl, placeholderImage: #imageLiteral(resourceName: "team_placeholder"), options: .continueInBackground) { (img, err, cacheType, url) in
//                                         }
//                                     }

    ...
    var isPaytmSelected: Bool = true {
           didSet {
               if isPaytmSelected {
                   ...
                   paytmImageView.backgroundColor =  UIColor(red: 8, green: 117, blue: 183)
                   //aMaleCheckBoxButton.backgroundColor = .blue
                   paytmButton.borderColor = UIColor(red: 8, green: 117, blue: 183)
                 bankButtom.borderColor =  UIColor(red: 8, green: 117, blue: 183)
                   paytmButton.borderWidth = 3
                  bankButtom.borderWidth = 3
                   bankButtom.backgroundColor = .white
               } else {
                   ...
                   bankButtom.borderWidth = 3
                 paytmButton.borderWidth = 3
                   bankImageView.backgroundColor =  UIColor(red: 8, green: 117, blue: 183)
                    paytmButton.borderColor = UIColor(red: 8, green: 117, blue: 183)
...
//        totalAmount = 0
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //   aFemaleCheckBoxButton.clipsToBounds = true
         //  aCameraButton.setCornerRadiusButton(value: 5)
           ...
           paytmButton.setBorderButton(color: UIColor(red: 8, green: 117, blue: 183), size: 1.0)
           bankButtom.setBorderButton(color:  UIColor(red: 8, green: 117, blue: 183), size: 1.0)
    ...
    @IBAction func withdrawAmount(_ sender: Any) {
     if aTotalAmountTextfield.text == "" {
        ...
        if text ?? 0 < 99 {
            Loader.showToast(message: "Please enter minimum 300 balance", onView: self.view, bottomMargin: 200, color: UIColor(red: 240, green: 75, blue: 80))
                           return
        }
        else {
    ...
    func getBankDetails() {
                  ...
                  if let heroObject = UserDefaults.standard.value(forKey: "loginData") as? NSData {
                      ...
                      NetworkManager.post_Request2(urlService: kBankDetailsURL, param: parameters as [String : Any], head: headers) { (response) in

...
//            self.myContest.setBackgroundImage(nil, for: .normal)
            ...
            myContest.setTitleColor(UIColor(red: 142, green: 145, blue: 147), for: .normal)
            myTeam.setTitleColor(UIColor(red: 142, green: 145, blue: 147), for: .normal)
            myTeamView.backgroundColor = .clear
            myContest.backgroundColor = .clear
            myContest.backgroundColor = .clear
            myTeam.backgroundColor = .clear
            //            myContestView.backgroundColor = UIColor(red: 185, green: 33, blue: 36)
            myTeam.borderColor = UIColor(red: 225, green: 225, blue: 225)
            myContest.borderColor = UIColor(red: 225, green: 225, blue: 225)
            UIView.animate(withDuration: 0.2) {
                self.contest.backgroundColor = UIColor(red: 253, green: 185, blue: 40)
                self.contest.borderColor = .clear
                self.contest.setTitleColor(UIColor(red: 0, green: 0, blue: 0), for: .normal)
                
            }
        //upcoming
        case 1:
            contest.setTitleColor(UIColor(red: 142, green: 145, blue: 147), for: .normal)
            myTeam.setTitleColor(UIColor(red: 142, green: 145, blue: 147), for: .normal)
            myTeamView.backgroundColor = .clear
            contestView.backgroundColor = .clear
            contest.backgroundColor = .clear
            myTeam.borderColor = UIColor(red: 225, green: 225, blue: 225)
                      contest.borderColor = UIColor(red: 225, green: 225, blue: 225)
                       myTeam.backgroundColor = .clear
...
//            contestView.backgroundColor = UIColor(red: 185, green: 33, blue: 36)
            ...
            UIView.animate(withDuration: 0.2) {
                self.myContest.backgroundColor = UIColor(red: 253, green: 185, blue: 40)
...
//                self.myContest.setBackgroundImage(#imageLiteral(resourceName: "Path 22587"), for: .normal)
                    self.myContest.borderColor = .clear
...
//                self.myTeam.setBackgroundImage(#imageLiteral(resourceName: "Path 22587"), for: .normal)
                 self.myTeam.borderColor = .clear
                self.myTeam.backgroundColor = UIColor(red: 253, green: 185, blue: 40)
...
//                cell.totalLeagueData = totalLeagues
                ...
                cell.delgate = self
                //              self.createButton.isHidden = true
                cell.showNoDataLabel(show: true, text: "No Match Found", image: #imageLiteral(resourceName: "no-match"), text2: "", buttonText: "", showButton: false)
                return cell
            }
        case 1 :
            ...
            if myjoinedContestdata.count > 0 {
                ...
                //                  self.createButton.isHidden = true
                cell.showNoDataLabel(show: true, text: "Find a Contest to join and start winning", image: #imageLiteral(resourceName: "no-match"), text2: "You haven't joined a any contest yet", buttonText: "Joined Contest", showButton: true)
                return cell1
            }
        case 2 :
            ...
            if getTeamResponse.count > 0 {
                ...
                cell2.showNoDataLabel(show: true, text: "No Upcomming Match Found", image: #imageLiteral(resourceName: "no-match"), text2: "You haven't created a any team yet", buttonText: "Create Team 1", showButton: true)
                return cell2
            }
        default:

...
//       self.notificationLbl.slideInFromLeft()
        aEntreeFeeLabel.roundCornersLbl(cornerRadius: 5.0)
        bonusLblPercent.roundCornersLbl(cornerRadius: 5.0)
...
//        }
    ...
    fileprivate func showBonusView(show: Bool) {
        ...
        bonousLblPercentWidthContraint.constant = show ? 30 : 0
    }
    ...
    fileprivate func showMultipleView(show: Bool) {
        ...
        maxTeamHeightConstraint.constant = show ? 25:0

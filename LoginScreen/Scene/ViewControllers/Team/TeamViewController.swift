...
class TeamViewController: BaseClass {
    ...
    @IBAction func clearTeamActon(_ sender: Any) {
        self.removeChangePassView()
    ...
    func setupUI() {
        choosePlayerLbl.text   =  "Pick 1 - 4 WICKET-KEEPERS"
    }
...
//        addNavigationBar(navigationTitle: "Create Team", titleContentMode: .left, isNavImageShow: false, isBackButtonShow: true, isWalletButtonShow: false, isBinButtonShow: true)
    ...
    fileprivate func moveSelectionView(index: Int) {
        ...
        case 0:
            ...
            self.choosePlayerLbl.text =  "Pick 1-4 WICKET-KEEPERS"
              sortingIndex = 0
        ...
        case 1:
            ...
            self.aBowlLabel.textColor = UIColor(red: 142, green: 145, blue: 147)
            self.aBowlValue.textColor = UIColor(red: 142, green: 145, blue: 147)
            self.choosePlayerLbl.text =  "Pick 3-6 BATSMAN"
              sortingIndex = 1
        ...
        case 2:
            ...
            self.aBowlLabel.textColor = UIColor(red: 142, green: 145, blue: 147)
            self.aBowlValue.textColor = UIColor(red: 142, green: 145, blue: 147)
            self.choosePlayerLbl.text =  "Pick 1-4 ALL ROUNDER"//
        ...
        case 3:
            ...
            self.aARLabel.textColor = UIColor(red: 142, green: 145, blue: 147)
            self.aAllValue.textColor = UIColor(red: 142, green: 145, blue: 147)
            self.choosePlayerLbl.text =  "Pick 3-6 BOWLERS"
            sortingIndex = 2
            UIView.animate(withDuration: 0.2) {
                self.aSelectionView.frame = CGRect(x: (0 + (selectionViewWidth * index )), y: 28, width: selectionViewWidth, height: 3)
...
//
//            Loader.showToast(message: "Please choose minimum 3 Batsman", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
//
//            return
//        }
//        if aAllValue.text == "0" {
...
//            return
//        }
//        if aBowlValue.text == "0" || aBowlValue.text == "1" || aBowlValue.text == "2" {
//            Loader.showToast(message: "Please choose minimum 3 Bowler", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
//
//            return
//        }
...
//                    strongSelf.aPlayerCollectionView.reloadDataInMainQueue()
                }
            }
            ...
            if APP_DEL.choosedTeamArray.count == 11 {
                ...
                if playerTeamCountSeven(player: playerid) {
                    ...
                    if checkCreaditLimitExceed(sPlayer: playerid) {
                        ...
                        if APP_DEL.chossedAllMansArray.count != 4 {
            ...
            if APP_DEL.choosedTeamArray.count == 11 {
                ...
                if playerTeamCountSeven(player: playerid) {
                    ...
                    if checkCreaditLimitExceed(sPlayer: playerid) {
                        ...
                        if APP_DEL.choosedWkMansArray.count != 4 {
                            ...
                            Loader.showToast(message:"You can Select only  4 Wicket Kepper", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

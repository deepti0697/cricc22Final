...
class ChangePasswordViewController: BaseClass {
    ...
    func setUp() {
        oldPasswordtxtfield.customHideSecureTextImage = #imageLiteral(resourceName: "view")
        oldPasswordtxtfield.customShowSecureTextImage = #imageLiteral(resourceName: "ic_password_view")
        cofirmPasswordTextField.customHideSecureTextImage = #imageLiteral(resourceName: "view")
        cofirmPasswordTextField.customShowSecureTextImage = #imageLiteral(resourceName: "ic_password_view")
        newPasswordTextField.customShowSecureTextImage = #imageLiteral(resourceName: "ic_password_view")
        ...
        nextBtn.setTitle(StringConstant.savePassword, for: .normal)

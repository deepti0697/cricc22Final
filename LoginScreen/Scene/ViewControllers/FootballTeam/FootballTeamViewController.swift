    ...
    var arrayOFPlayer  = [Int]()
        ...
        override func viewWillAppear(_ animated: Bool) {
           ...
           self.playerStatusView.isHidden = true
            ...
            addNavigationBar(navigationTitle: "Create Team", titleContentMode: .left, isNavImageShow: false, isBackButtonShow: true, isWalletButtonShow: false, isBinButtonShow: true)
        }
        ...
        fileprivate func resetAllData() {
            ...
            self.tempBowlerArray.removeAll()
            self.tempBatsmenrArray.removeAll()
            self.tempAllrounderArray.removeAll()
            self.tempkeeperArray.removeAll()
    }
        ...
        fileprivate func moveSelectionView(index: Int) {
            ...
            case 1:
                ...
                self.aBowlLabel.textColor = UIColor(red: 142, green: 145, blue: 147)
                self.aBowlValue.textColor = UIColor(red: 142, green: 145, blue: 147)
                self.choosePlayerLbl.text =  "Pick 3-5 DEFENDER"
                sortingIndex = 1
            ...
            case 2:
                ...
                self.aBowlLabel.textColor = UIColor(red: 142, green: 145, blue: 147)
                self.aBowlValue.textColor = UIColor(red: 142, green: 145, blue: 147)
                self.choosePlayerLbl.text =  "Pick 3-5 MIDFIELDER"//
    ...
    func sendDatatoMainVc(player: PlayerListResponses) {
     ...
     func sendPlayerInfotoRemove(playerid: PlayerListResponses) {
        ...
        func minimumPlayerWarning() {
                if (APP_DEL.FootballchoosedDefenderArray.count < 3) {
                    Loader.showToast(message:"You must select at least 3 Defender.", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

                  } else if (APP_DEL.FootballchoosedMidFielderArray.count < 3) {
                    Loader.showToast(message: "You must select at least 3 MidFielder.", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
                ...
                if APP_DEL.footballChoosedTeamArray.count == 11 {
                    ...
                    if playerTeamCountSeven(player: playerid) {
                        ...
                        if checkCreaditLimitExceed(sPlayer: playerid) {
                            ...
                            if APP_DEL.FootballchoosedDefenderArray.count != 5 {
                                ...
                                aPlayerCollectionView.reloadDataInMainQueue()
                                    ...
                                    Loader.showToast(message: "You can select only 5 Defender", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
                ...
                if APP_DEL.footballChoosedTeamArray.count == 11 {
                    ...
                    if playerTeamCountSeven(player: playerid) {
                        ...
                        if checkCreaditLimitExceed(sPlayer: playerid) {
                            ...
                            if APP_DEL.FootballchoosedMidFielderArray.count != 5 {
                                ...
                                aPlayerCollectionView.reloadDataInMainQueue()
                                    ...
                                    Loader.showToast(message: "You can Select only 5 Mid-Fielder", onView: self.view, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

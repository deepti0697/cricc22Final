...
//            addFundRequest(txnID: orderId, orderID: orderId, paymentType: "Cashfree", amount: amtTxt)
        ...
        var lblarra = ["PayTm","CashFree"]
        var imageArray = [#imageLiteral(resourceName: "paytm_226448"),#imageLiteral(resourceName: "Mask Group 15")]
        let environment = "PROD" // Use "PROD" when you are ready to go live.
             let appId = "51463ff7cca2b2439d7c040fe36415" // <-Prod // "63254b2e71265f0516721e205236" // <-Test
             let appSecret = "e711498a9ad7810edc1a2fa3ebfbf1c52cc173e0"

//" // <-Prod  "5ec949ef9c42ca1e909ab38152ba02692939e2fe" // <-Test
             let color1Hex = "#6a5594ff"
             let merchantName = "DreamTeam"
             let notifyUrl = "https://dreamteams.co.in/dt_admin/admin/cashfree_notify"
...
//        }
    ...
    extension PauemtOptionsViewController {
         func getPaytmCheckSum() {
                ...
                let parameters = ["MID": "Cric2242167418944417",
                                  "ORDER_ID": orderId,
                                  "CUST_ID": customerID,
            ...
            func initaitePaytmPayment() {
                ...
                order.params = ["MID": paytmParam.mID ?? "Cric2242167418944417",
                    ...
                    "INDUSTRY_TYPE_ID": paytmParam.iNDUSTRY_TYPE_ID ?? "Retail105",

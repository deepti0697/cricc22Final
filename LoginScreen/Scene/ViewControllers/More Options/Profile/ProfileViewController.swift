    ...
    var isMaleButtonSelected: Bool = true {
        didSet {
            if isMaleButtonSelected {
                ...
                maleImageView.backgroundColor =  UIColor(red: 8, green: 117, blue: 183)
                //aMaleCheckBoxButton.backgroundColor = .blue
                aMaleCheckBoxButton.borderColor = UIColor(red: 8, green: 117, blue: 183)
                ...
                aFemaleCheckBoxButton.borderColor =  UIColor(red: 8, green: 117, blue: 183)
                aFemaleCheckBoxButton.borderWidth = 3
                femaleImageView.backgroundColor =  UIColor(red: 8, green: 117, blue: 183)
    ...
    func setupUI() {
     ...
     //   aFemaleCheckBoxButton.clipsToBounds = true
      //  aCameraButton.setCornerRadiusButton(value: 5)
        ...
        aMaleCheckBoxButton.setBorderButton(color: UIColor(red: 8, green: 117, blue: 183), size: 1.0)
        aFemaleCheckBoxButton.setBorderButton(color:  UIColor(red: 8, green: 117, blue: 183), size: 1.0)
        ...
        if let heroObject = UserDefaults.standard.value(forKey: "loginData") as? NSData {
            ...
            if let  checkEmail = (UserDic.value(forKey: "email_verify")) {
                if checkEmail as? Int == -1 || checkEmail as? Int == 0 as Int {
                    aEmailTextField.isEnabled = true
                }
                else {
            ...
            if let checkMobile = (UserDic.value(forKey: "mobile_verify")) {
                               if checkMobile as? Int == -1 || checkMobile as? Int == 0 as Int {
                                   aPhoneTextField.isEnabled = true
                           }
                               else {

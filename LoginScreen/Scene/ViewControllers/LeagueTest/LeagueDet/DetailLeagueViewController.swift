...
class DetailLeagueViewController: BaseClass {
    ...
    override func viewDidLoad() {
        ...
        prizeBtn.imageView?.tintColor = .white
        entryBtn.imageView?.tintColor = .white
        winnrBtn.imageView?.tintColor = .white
        spotBtn.imageView?.tintColor = .white
    }
    ...
    @IBAction func filterPrizePool(_ sender: UIButton) {
        ...
        if sender.isSelected {
            ...
            sender.setImage(#imageLiteral(resourceName: "upArrow"), for: .selected)
 sender.setImage(#imageLiteral(resourceName: "upArrow"), for: .normal)
            ...
            sender.setImage(#imageLiteral(resourceName: "Path 22322"), for: .normal)
sender.setImage(#imageLiteral(resourceName: "Path 22322"), for: .selected)
            leagueData =  leagueData.sorted {
                        ($0.win_amount ?? 0) <  ($1.win_amount ?? 0)
    ...
    @IBAction func entryFilter(_ sender: UIButton) {
        ...
        if sender.isSelected {
                       sender.setImage(#imageLiteral(resourceName: "upArrow"), for: .normal)
                          sender.setImage(#imageLiteral(resourceName: "Path 22322 copy"), for: .selected)
            ...
            leagueData =  leagueData.sorted {
                          ...
                          sender.setImage(#imageLiteral(resourceName: "Path 22322"), for: .normal)
                          sender.setImage(#imageLiteral(resourceName: "DownArrrow"), for: .selected)
            leagueData =  leagueData.sorted {
                                                   ($0.entryfee ?? 0) >  ($1.entryfee ?? 0)
    ...
    @IBAction func spotLeft(_ sender: UIButton) {
       ...
       if sender.isSelected {
        ...
        leagueData =  leagueData.sorted {
                   ...
                   sender.setImage(#imageLiteral(resourceName: "DownArrrow"), for: .normal)
    ...
    @IBAction func winners(_ sender: UIButton) {
        ...
        prizeBtn.setImage(nil, for: .selected)
             ...
             entryBtn.setImage(nil, for: .selected)
         if sender.isSelected {
            if sender.imageView?.image == #imageLiteral(resourceName: "DownArrrow") {
             sender.setImage(#imageLiteral(resourceName: "upArrow"), for: .selected)
 sender.setImage(#imageLiteral(resourceName: "upArrow"), for: .normal)
                leagueData =  leagueData.sorted {
...
//            vc.maxTeamlimit = leagues.maximum_user ?? 0

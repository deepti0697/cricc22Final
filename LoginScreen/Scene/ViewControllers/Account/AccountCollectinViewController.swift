            ...
            NetworkManager.post_Request(urlService: kAllVerify, param: parameters as [String : Any], head: headers) { (response) in
                ...
                do {
                    if response != nil {
                        ...
                        if self.allverifyResp?.pan_verify == -1 {
                        ...
                        if self.allverifyResp?.bank_verify == -1 {
    ...
    func setup() {
        if let heroObject = UserDefaults.standard.value(forKey: "UserDetail") as? NSData {
            ...
            let imageUrl = URL(string: string as? String ?? "" )
             name.text = UserDic.value(forKey: "username") as? String
    ...
    func UPLOD(imgData:Data)
    {
        ...
        if let heroObject = UserDefaults.standard.value(forKey: "loginData") as? NSData {
            ...
            Alamofire.upload(multipartFormData: { multipartFormData in
               ...
               to: "https://dreamteams.co.in/api/auth/update-profile-image", //URL Here
                method: .post,
...
//    performSegue(withIdentifier: "accountToAddCashSegue", sender: nil)
    ...
    fileprivate func moveSelectionView(index: Int) {
        ...
        //Live
        case 0:
            transactionOutlt.setTitleColor(UIColor(red: 255, green: 255, blue: 255), for: .normal)
            PayingHistoryOutlt.setTitleColor(UIColor(red: 255, green: 255, blue: 255), for: .normal)
            
            // myView.heightAnchor.constraint(equalToConstant: 100).isActive = true
            UIView.animate(withDuration: 0.2) {
                self.selectionView.frame = CGRect(x: 0, y: 35, width: selectionViewWidth, height: 5)
                self.BalanceOutlt.setTitleColor(UIColor(red: 255, green: 255, blue: 255), for: .normal)
                
            }
        //upcoming
        case 1:
            transactionOutlt.setTitleColor(UIColor(red: 255, green: 255, blue: 255), for: .normal)
            BalanceOutlt.setTitleColor(UIColor(red: 255, green: 255, blue: 255), for: .normal)
        ...
        case 2:
            ...
            UIView.animate(withDuration: 0.2) {
                ...
                self.transactionOutlt.setTitleColor(UIColor(red: 255, green: 255, blue: 255), for: .normal)
            }
        default:
            break
        }

...
//        }
        if data.lineup == 1 {
            ...
            self.ContainerView.borderColor = .green
         ...
         if let imagePath1 = data.team1logo {
                   ...
                   team1image?.sd_setImage(with: imageUrl, placeholderImage: #imageLiteral(resourceName: "team_placeholder"), options: .continueInBackground) { (img, err, cacheType, url) in
                   }
               }
               if let imagePath2 = data.team2logo {
                   ...
                   team2Image?.sd_setImage(with: imageUrl, placeholderImage: #imageLiteral(resourceName: "team_placeholder"), options: .continueInBackground) { (img, err, cacheType, url) in
                   }
               }

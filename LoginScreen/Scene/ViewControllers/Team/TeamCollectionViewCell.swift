    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            if APP_DEL.choosedTeamArray.contains(where: {$0.id == obj.id}) {
                ...
                else if APP_DEL.choosedWkMansArray.count == 4 {
                      cell.DullView.alpha = 0.3
                }
                else {
                    cell.DullView.alpha = 1
        ...
        case 1:
            ...
            if APP_DEL.choosedTeamArray.contains(where: {$0.id == obj.id}) {
               ...
               cell.DullView.alpha = 1
                ...
                if APP_DEL.choosedBatMansArray.count >= 3 && APP_DEL.extraPlayer == 0 {
                    
                    
                     cell.DullView.alpha = 0.3
                }
                else if APP_DEL.choosedBatMansArray.count == 6 {
                     cell.DullView.alpha = 0.3
                }
                else {
                     cell.DullView.alpha = 1
        ...
        case 2:
            ...
            if APP_DEL.choosedTeamArray.contains(where: {$0.id == obj.id}) {
              ...
              cell.DullView.alpha = 1
                ...
                if APP_DEL.chossedAllMansArray.count >= 1 && APP_DEL.extraPlayer == 0 {
                                  
                                   cell.DullView.alpha = 0.3
                                  
                                             }
                else if APP_DEL.chossedAllMansArray.count == 4 {
                     cell.DullView.alpha = 0.3
                }
                                  else {
                                   cell.DullView.alpha = 1
        ...
        case 3:
            ...
            if APP_DEL.choosedTeamArray.contains(where: {$0.id == obj.id}) {
                ...
                if APP_DEL.choosedBowlMansArray.count >= 3 && APP_DEL.extraPlayer == 0 {
                                    cell.DullView.alpha = 0.3
                                  
                                          }
                else if APP_DEL.choosedBowlMansArray.count == 6 {
                    cell.DullView.alpha = 0.3
                }
                               else {
                                    cell.DullView.alpha = 1
...
//                                checkSelectionStatus()
                                ...
                                Loader.showToast(message: "You can Select only 4 Wicket-Keepers", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
                            }
                        }
                    }
                }
...
//                                checkAllSelectionStatus()
                                ...
                                Loader.showToast(message: "You can Select only  4 All Rounder", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
                            }
                        }
                    }
                }
...
//                                checkBallManSelectionStatus()
    ...
    func minimumPlayerWarning() {
        if (APP_DEL.choosedBowlMansArray.count < 3) {
             Loader.showToast(message:"You must select at least 3 Bowlers.", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

          } else if (APP_DEL.choosedBatMansArray.count < 3) {
Loader.showToast(message: "You must select at least 3 Batsmen.", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
...
Loader.showToast(message: "You must select at least 1 Wicket-Keepers.", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
            ...
            Loader.showToast(message: "You must select at least 1 All-Rounders.", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

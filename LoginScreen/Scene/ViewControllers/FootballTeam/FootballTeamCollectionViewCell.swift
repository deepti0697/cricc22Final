    ...
    extension FootballTeamCollectionViewCell: UITableViewDelegate, UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            case 0:
                ...
                //  cell.configureCell(playerData: APP_DEL.editWkMansArray[indexPath.item])
                ...
                let obj = APP_DEL.FootballDefenderArray[indexPath.item]
                           if APP_DEL.footballChoosedTeamArray.contains(where: {$0.id == obj.id}) {
                            ...
                            cell.DullView.alpha = 1
                               ...
                               if APP_DEL.FootballchoosedDefenderArray.count >= 3 && APP_DEL.FootballExtraPlayer == 0 {
                                   
                                   cell.DullView.alpha = 0.3
                                   
                               }
                               else if APP_DEL.FootballchoosedDefenderArray.count == 5 {
                                    cell.DullView.alpha = 0.3
                               }
                               else {
                                   cell.DullView.alpha = 1
            ...
            case 2:
                let obj = APP_DEL.FootballMidFielderArray[indexPath.item]
                                     if APP_DEL.footballChoosedTeamArray.contains(where: {$0.id == obj.id}) {
                                         ...
                                         if APP_DEL.FootballchoosedMidFielderArray.count >= 3 && APP_DEL.FootballExtraPlayer == 0 {
                ...
                let obj = APP_DEL.FootballFowordArray[indexPath.item]
                                                if APP_DEL.footballChoosedTeamArray.contains(where: {$0.id == obj.id}) {
                                                    ...
                                                    cell.DullView.alpha = 1
                                                        ...
                                                        else if APP_DEL.FootballchoosedDefenderArray.count == 3 {
                                                             cell.DullView.alpha = 0.3
                                                        }
                                                        else {
                                                            cell.DullView.alpha = 1
                            ...
                            if checkCreaditLimitExceed(sPlayer: APP_DEL.FootballDefenderArray[indexPath.row]) {
                                ...
                                if APP_DEL.FootballchoosedDefenderArray.count != APP_DEL.maxDef {
                                    ...
                                    addPlayerInArray(player: APP_DEL.FootballDefenderArray[indexPath.row])
                                        ...
                                        Loader.showToast(message: "You can Select only  5 Defender", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
                            ...
                            if checkCreaditLimitExceed(sPlayer: APP_DEL.FootballMidFielderArray[indexPath.row]) {
                                ...
                                if APP_DEL.FootballchoosedMidFielderArray.count != APP_DEL.maxMid {
                                    ...
                                    addPlayerInArray(player: APP_DEL.FootballMidFielderArray[indexPath.row])
                                        ...
                                        Loader.showToast(message: "You can Select only 5 MIDFIELDER", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
                                                                    }
                            }
                        }
                    }
                            ...
                            if checkCreaditLimitExceed(sPlayer: APP_DEL.FootballFowordArray[indexPath.row]) {
                                ...
                                if  APP_DEL.FootballchoosedFowordArray.count != 3  {
                                    ...
                                    addPlayerInArray(player: APP_DEL.FootballFowordArray[indexPath.row])
                                        ...
                                        Loader.showToast(message: "You can Select only 3 Forword", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))
    ...
    //    }
        func minimumPlayerWarning() {
                if (APP_DEL.FootballchoosedDefenderArray.count < 3) {
                     Loader.showToast(message:"You must select at least 3 Defender.", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

                  } else if (APP_DEL.FootballchoosedMidFielderArray.count < 3) {
        Loader.showToast(message: "You must select at least 3 MidFielder.", onView: self, bottomMargin: 30 , color: UIColor(red: 240, green: 75, blue: 80))

...
//      let vc = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "DetailLeagueViewController") as! DetailLeagueViewController
//        vc.entryArrays = self.entryArray
//        vc.multiEntryArrays = self.multiEntryArray
//        vc.contestSArrays = self.contestSArray
//        vc.winningArrays = self.winningArray
